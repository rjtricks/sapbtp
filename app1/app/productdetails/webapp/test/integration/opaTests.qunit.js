...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "productdetails/productdetails/test/integration/FirstJourney",
    "productdetails/productdetails/test/integration/ProductListJourney",
    "productdetails/productdetails/test/integration/ProductObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
